...
A list of features and concepts that we’d love to see in Devloop over the next year. Some of these are motivated by direct community support, and some of them are things that we’re personally excited about and feel would enhance the experience of using Devloop.
...
### Polish Devloop's Deployer platform extensibility.
