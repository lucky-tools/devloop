...
func TestNewCmdDebug(t *testing.T) {
	testutil.Run(t, "", func(t *testutil.T) {
		t.NewTempDir().Chdir()
		t.Override(&opts, config.DevloopOptions{})
...
// https://github.com/lucky-tools/devloop/issues/4129
...
func TestDebugIndependentFromDev(t *testing.T) {
	...
	testutil.Run(t, "DevDebug", func(t *testutil.T) {
		t.Override(&createRunner, func(context.Context, io.Writer, config.DevloopOptions) (runner.Runner, []util.VersionedConfig, *runcontext.RunContext, error) {
			return mockRunner, []util.VersionedConfig{&latest.DevloopConfig{}}, nil, nil
		})
		t.Override(&opts, config.DevloopOptions{})
