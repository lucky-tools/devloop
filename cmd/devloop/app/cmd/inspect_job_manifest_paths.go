...
import (
	...
	jobManifestPaths "github.com/lucky-tools/devloop/pkg/devloop/inspect/jobManifestPaths"
...
func cmdJobManifestPaths() *cobra.Command {
	return NewCmd("jobManifestPaths").
		WithDescription("View devloop jobManifestPath information defined in the specified devloop configuration").
...
func cmdJobManifestPathsList() *cobra.Command {
	return NewCmd("list").
		...
		WithDescription("Print the list of jobManifestPaths that would be run for a given configuration (default devloop configuration, specific module, specific profile, etc).").
...
func cmdJobManifestPathsModify() *cobra.Command {
	return NewCmd("modify").
		WithExample("Modify the devloop verify jobManifestPaths", "inspect jobManifestPaths list --format json").
