...
import (
	...
	modules "github.com/lucky-tools/devloop/pkg/devloop/inspect/modules"
)
...
func cmdModulesList() *cobra.Command {
	return NewCmd("list").
		...
		WithDescription("Print the list of module names that can be invoked with the --module flag in other devloop commands.").
