...
<a name="v1/devloop.proto"></a>

## v1/devloop.proto

You can find the source for v1/devloop.proto [on Github](https://github.com/lucky-tools/devloop/blob/main/proto/v1/devloop.proto).



### Services

<a name="proto.DevloopService"></a>
...
| ----------- | ------------ | ------------- | ------------|
| GetState | [.google.protobuf.Empty](#google.protobuf.Empty) | [State](#proto.State) | Returns the state of the current Devloop execution |
| EventLog | [LogEntry](#proto.LogEntry) stream | [LogEntry](#proto.LogEntry) stream | DEPRECATED. Events should be used instead. TODO remove (https://github.com/lucky-tools/devloop/issues/3168) |
| Events | [.google.protobuf.Empty](#google.protobuf.Empty) | [LogEntry](#proto.LogEntry) stream | Returns all the events of the current Devloop execution from the start |
...
#### BuildEvent
`BuildEvent` describes the build status per artifact, and will be emitted by Devloop anytime a build starts or finishes, successfully or not.
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| artifacts | [BuildState.ArtifactsEntry](#proto.BuildState.ArtifactsEntry) | repeated | A map of `artifact name -> build-state`. Artifact name is defined in the `devloop.yaml`. The `build-state` can be: <br> - `"Not started"`: not yet started <br> - `"In progress"`: build started <br> - `"Complete"`: build succeeded <br> - `"Failed"`: build failed |
...
#### DeployEvent
`DeployEvent` represents the status of a deployment, and is emitted by Devloop
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| metaEvent | [MetaEvent](#proto.MetaEvent) |  | contains general information regarding Devloop like version info |
...
| terminationEvent | [TerminationEvent](#proto.TerminationEvent) |  | describes a devloop termination event |
...
| metadata | [Metadata](#proto.Metadata) |  | Metadata describing devloop pipeline |
...
#### TestEvent
`TestEvent` represents the status of a test, and is emitted by Devloop
