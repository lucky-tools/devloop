...
An example showing how these fields can be used is below.  Run `devloop render` in a directory with the following files:
...
To use kpt with Devloop, add render type `kpt` to the `manifests`
