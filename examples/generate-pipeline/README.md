### Example: Getting started with devloop and CI/CD using Tekton

[![Open in Cloud Shell](https://gstatic.com/cloudssh/images/open-btn.svg)](https://ssh.cloud.google.com/cloudshell/editor?cloudshell_git_repo=https://github.com/lucky-tools/devloop&cloudshell_open_in_editor=README.md&cloudshell_workspace=examples/generate-pipeline)
...
* Run devloop generate-pipeline
* Modify devloop.yaml to use a valid GCSbucket for kaniko
* Commit and push updated devloop.yaml
