### Example: Running devloop lifecycle hooks

[![Open in Cloud Shell](https://gstatic.com/cloudssh/images/open-btn.svg)](https://ssh.cloud.google.com/cloudshell/editor?cloudshell_git_repo=https://github.com/lucky-tools/devloop&cloudshell_open_in_editor=README.md&cloudshell_workspace=examples/lifecycle-hooks)

This is a simple example to show how to inject devloop lifecycles with user-defined hooks.
...
...
```
If you change the text of `hello.txt` file, say to `Hello World!!`, Devloop will `sync` it into the running container.
