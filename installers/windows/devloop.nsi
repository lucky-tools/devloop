!define APP_NAME "Devloop"
!define COMP_NAME "Devloop"
!define WEB_SITE "https://devloop.dev"
!define VERSION "$%DEVLOOP_VERSION%"
!define COPYRIGHT "Devloop Authors, 2021"
!define DESCRIPTION "Fast. Repeatable. Simple. Container & Kubernetes Development"
!define INSTALLER_NAME "devloop_installer.exe"
!define MAIN_APP_EXE "devloop.exe"
...
Section -MainProgram
	...
	Rename "$INSTDIR\\devloop-windows-amd64.exe" "$INSTDIR\\devloop.exe"
