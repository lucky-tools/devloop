...
func init() {
	proto.RegisterType((*VisitorCounterRequest)(nil), "devloop.examples.e2e.visitor.VisitorCounterRequest")
	proto.RegisterType((*UpdateVisitorRequest)(nil), "devloop.examples.e2e.visitor.UpdateVisitorRequest")
	proto.RegisterType((*UpdateVisitorResponse)(nil), "devloop.examples.e2e.visitor.UpdateVisitorResponse")
	proto.RegisterType((*VisitorCounterResponse)(nil), "devloop.examples.e2e.visitor.VisitorCounterResponse")
	proto.RegisterType((*Visitor)(nil), "devloop.examples.e2e.visitor.Visitor")
}
