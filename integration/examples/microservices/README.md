### Example: µSvcs with Devloop

[![Open in Cloud Shell](https://gstatic.com/cloudssh/images/open-btn.svg)](https://ssh.cloud.google.com/cloudshell/editor?cloudshell_git_repo=https://github.com/lucky-tools/devloop&cloudshell_open_in_editor=README.md&cloudshell_workspace=examples/microservices)

In this example:

* Deploy multiple applications with devloop
...
Let's walk through the first part of the devloop.yaml
