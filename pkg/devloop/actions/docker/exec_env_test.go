		...
		},
		{
			...
			availableAcsCfgs: []latest.Action{
				getActionCfg("action1", []latest.VerifyContainer{
					{Name: "container1", Image: "gcr.io/k8s-devloop/mock:latest"},
					{Name: "container2", Image: "gcr.io/k8s-devloop/mock:latest"},
				}, false),
				getActionCfg("action2", []latest.VerifyContainer{
					{Name: "container3", Image: "gcr.io/k8s-devloop/mock:latest"},
					{Name: "container4", Image: "gcr.io/k8s-devloop/mock:latest"},
				}, false),
			},
		},
	}
...
func TestExecEnv_PullImages(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			availableAcsCfgs: []latest.Action{
				getActionCfg("action1", []latest.VerifyContainer{
					{Name: "container1", Image: "gcr.io/k8s-devloop/mock1:latest"},
					{Name: "container2", Image: "gcr.io/k8s-devloop/mock2:latest"},
				}, true),
			},
			expectedPulledImgs: []string{"gcr.io/k8s-devloop/mock1:latest", "gcr.io/k8s-devloop/mock2:latest"},
		},
		{
		...
		},
		{
			...
			imagesInDaemon: map[string]string{
				"gcr.io/k8s-devloop/mock2:latest": "id1111",
				"gcr.io/k8s-devloop/mock1:latest": "id2222",
			},
		},
		{
			...
			expectedPulledImgs: []string{
				"gcr.io/k8s-devloop/mock2:latest",
			},
			imagesInDaemon: map[string]string{
				"gcr.io/k8s-devloop/mock1:latest": "id2222",
			},
		},
		{
			...
			expectedPulledImgs: []string{
				"gcr.io/k8s-devloop/mock1:latest",
			},
			imagesInDaemon: map[string]string{
				"gcr.io/k8s-devloop/mock1:latest": "id1111",
				"mock2:latest":                    "id2222",
			},
		},
	}
