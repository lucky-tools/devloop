...
// Builder is an interface to the Build API of Devloop.
...
type Builder interface {
	...
	// Prune removes images built with Devloop
	Prune(context.Context, io.Writer) error
}

// PipelineBuilder is an interface for a specific Devloop config pipeline build type.
// Current implementations are the `local` and `cluster`
