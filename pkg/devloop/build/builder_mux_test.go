	...
	tests := []struct {
	...
	}{
		{
			...
			pbs: []PipelineBuilder{
				...
				&mockPipelineBuilder{concurrency: nil, builderType: "cluster"},
			},
			cliConcurrency:      -1,
			expectedConcurrency: 1,
		},
		...
		},
		{
			...
			pbs: []PipelineBuilder{
				...
				&mockPipelineBuilder{concurrency: util.Ptr(0), builderType: "cluster"},
			},
			cliConcurrency:      1,
			expectedConcurrency: 1,
		},
		...
		{
			description: "builder concurrency set to default 0 for cluster",
			pbs: []PipelineBuilder{
				// build all in parallel
				&mockPipelineBuilder{concurrency: util.Ptr(0), builderType: "cluster"},
				&mockPipelineBuilder{concurrency: util.Ptr(0), builderType: "cluster"},
		...
		},
		{
			...
			pbs: []PipelineBuilder{
				&mockPipelineBuilder{concurrency: util.Ptr(0), builderType: "local"},
				&mockPipelineBuilder{concurrency: util.Ptr(3), builderType: "cluster"},
				&mockPipelineBuilder{concurrency: util.Ptr(2), builderType: "cluster"},
			},
			cliConcurrency:      -1,
			expectedConcurrency: 2,
		},
