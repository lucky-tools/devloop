...
func TestBuild(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			importPath := "ko://github.com/lucky-tools/devloop/pkg/devloop/build/ko" // this package
...
func Test_getImportPath(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedImportPath: "ko://github.com/lucky-tools/devloop/pkg/devloop/build/ko", // this package
		},
		{
			...
			expectedImportPath: "ko://github.com/lucky-tools/devloop/pkg/devloop/build/ko/testdata/package-main-in-root",
		},
		{
			...
			expectedImportPath: "ko://github.com/lucky-tools/devloop/pkg/devloop/build/ko/testdata/package-main-not-in-root/baz",
		},
		{
