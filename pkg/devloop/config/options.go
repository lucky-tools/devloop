...
// DevloopOptions are options that are set by command line arguments not included in the config file itself
...
func (opts *DevloopOptions) Prune() bool {
	return !opts.NoPrune && !opts.CacheArtifacts
}

func (opts *DevloopOptions) Mode() RunMode {
	return RunMode(opts.Command)
}

func (opts *DevloopOptions) IsTargetImage(artifact *latest.Artifact) bool {
