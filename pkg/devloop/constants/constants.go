...
const (
	...
	HelmOverridesFilename = "devloop-overrides.yaml"
	...
	// DevloopEnvFile is the file that is parsed to set environment variables in the process
	DevloopEnvFile = "devloop.env"
	...
	GithubIssueLink = "https://github.com/lucky-tools/devloop/issues/new"
...
var Labels = struct {
	...
	TagPolicy:        "devloop.dev/tag-policy",
	Deployer:         "devloop.dev/deployer",
	Builder:          "devloop.dev/builder",
	DockerAPIVersion: "devloop.dev/docker-api-version",
}
