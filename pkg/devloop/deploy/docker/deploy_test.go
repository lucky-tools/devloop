...
import (
	...
	devlooputil "github.com/lucky-tools/devloop/pkg/devloop/util"
...
func TestDebugBindings(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.name, func(tt *testutil.T) {
			tt.Override(&dockerport.GetAvailablePort, func(_ string, port int, usedPorts *devlooputil.PortSet) int {
				for {
