...
func TestKptfileInitIfNot(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			k, _ := NewDeployer(&kptConfig{}, &label.DefaultLabeller{}, &latest.KptDeploy{Dir: "."}, config.DevloopOptions{}, "default", nil)
...
func TestDeploy(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			k, err := NewDeployer(&kptConfig{}, &label.DefaultLabeller{}, &test.kpt, config.DevloopOptions{}, "default", nil)
			t.CheckNoError(err)
