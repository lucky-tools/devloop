...
func (l logger) Write(p []byte) (int, error) {
	handler.handleDevloopLogEvent(&proto.DevloopLogEvent{
...
func (ev *eventHandler) handleDevloopLogEvent(e *proto.DevloopLogEvent) {
...
// logHook is an implementation of logrus.Hook used to send DevloopLogEvents
type logHook struct{}
...
// Fire constructs a DevloopLogEvent and sends it to the event channel
