				...
				PreHooks: []latest.RenderHookItem{
					{
						HostHook: &latest.HostHook{
							...
							Command: []string{"sh", "-c", "echo pre-hook running with DEVLOOP_KUBE_CONTEXT=$DEVLOOP_KUBE_CONTEXT,DEVLOOP_NAMESPACES=$DEVLOOP_NAMESPACES"},
						},
					},
				},
				PostHooks: []latest.PostRenderHookItem{
					{
						HostHook: &latest.PostRenderHostHook{
							OS:      []string{"linux", "darwin"},
							Command: []string{"sh", "-c", "echo post-hook running with DEVLOOP_KUBE_CONTEXT=$DEVLOOP_KUBE_CONTEXT,DEVLOOP_NAMESPACES=$DEVLOOP_NAMESPACES"},
						},
					},
				},
			},
			preHostHookOut:  "pre-hook running with DEVLOOP_KUBE_CONTEXT=context1,DEVLOOP_NAMESPACES=np1,np2",
			postHostHookOut: "post-hook running with DEVLOOP_KUBE_CONTEXT=context1,DEVLOOP_NAMESPACES=np1,np2",
		},
		{
				...
				PreHooks: []latest.RenderHookItem{
					{
						HostHook: &latest.HostHook{
							OS:      []string{"windows"},
							Command: []string{"pwsh", "-Command", "echo", "pre-hook running with DEVLOOP_KUBE_CONTEXT=$([Environment]::GetEnvironmentVariable('DEVLOOP_KUBE_CONTEXT')),DEVLOOP_NAMESPACES=$([Environment]::GetEnvironmentVariable('DEVLOOP_NAMESPACES'))"},
						},
					},
				},
				PostHooks: []latest.PostRenderHookItem{
					{
						HostHook: &latest.PostRenderHostHook{
							OS:      []string{"windows"},
							Command: []string{"pwsh", "-Command", "echo", "post-hook running with DEVLOOP_KUBE_CONTEXT=$([Environment]::GetEnvironmentVariable('DEVLOOP_KUBE_CONTEXT')),DEVLOOP_NAMESPACES=$([Environment]::GetEnvironmentVariable('DEVLOOP_NAMESPACES'))"},
						},
					},
				},
			},
