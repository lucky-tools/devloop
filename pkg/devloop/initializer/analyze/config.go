...
import (
	...
	"github.com/lucky-tools/devloop/pkg/devloop/initializer/errors"
	"github.com/lucky-tools/devloop/pkg/devloop/schema"
)

type devloopConfigAnalyzer struct {
	directoryAnalyzer
	force        bool
	analyzeMode  bool
	targetConfig string
...
func (a *devloopConfigAnalyzer) analyzeFile(ctx context.Context, filePath string) error {
	if !schema.IsDevloopConfig(filePath) || a.force || a.analyzeMode {
		return nil
	}
