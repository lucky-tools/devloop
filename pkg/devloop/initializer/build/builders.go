...
// InitBuilder represents a builder that can be chosen by devloop init.
type InitBuilder interface {
	...
	// To make devloop.yaml more portable across OS-es we should always generate /-delimited filepaths.
...
type Initializer interface {
	...
	// BuildConfig returns the processed build config to be written to the devloop.yaml
