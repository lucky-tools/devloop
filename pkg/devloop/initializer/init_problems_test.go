...
func TestInitProblems(t *testing.T) {
	initTestCases := []struct {
	...
	}{
		{
			...
			expected:    "creating tagger: something went wrong. If above error is unexpected, please open an issue to report this error at https://github.com/lucky-tools/devloop/issues/new.",
			expectedAE: &proto.ActionableErr{
		...
		},
		{
			...
			expected:    "creating runner: creating builder: something went wrong. If above error is unexpected, please open an issue to report this error at https://github.com/lucky-tools/devloop/issues/new.",
			expectedAE: &proto.ActionableErr{
		...
		},
		{
			...
			expected:    "creating runner: unexpected artifact type `DockerrArtifact`. If above error is unexpected, please open an issue to report this error at https://github.com/lucky-tools/devloop/issues/new.",
			expectedAE: &proto.ActionableErr{
		...
		},
		{
			...
			expected:    "creating runner: expanding test file paths: .src/test. If above error is unexpected, please open an issue to report this error at https://github.com/lucky-tools/devloop/issues/new.",
			expectedAE: &proto.ActionableErr{
		...
		},
		{
			...
			expected:    "creating runner: initializing cache at some error. If above error is unexpected, please open an issue to report this error at https://github.com/lucky-tools/devloop/issues/new.",
			expectedAE: &proto.ActionableErr{
