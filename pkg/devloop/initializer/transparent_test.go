...
func TestTransparentInit(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.name, func(t *testutil.T) {
			...
			t.Override(&confirmInitOptions, func(_ io.Writer, _ *latest.DevloopConfig) (bool, error) {
			...
			case test.doneResponse == true:
				t.CheckErrorAndDeepEqual(false, err, (*latest.DevloopConfig)(nil), got)
			default:
				t.CheckNoError(err)
