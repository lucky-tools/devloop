...
func PrintProfilesList(ctx context.Context, out io.Writer, opts inspect.Options) error {
	...
	cfgs, err := inspect.GetConfigSet(ctx, config.DevloopOptions{ConfigurationFile: opts.Filename, ConfigurationFilter: opts.Modules, RemoteCacheDir: opts.RemoteCacheDir})
	if err != nil {
