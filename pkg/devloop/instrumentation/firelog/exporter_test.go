...
func TestBuildProtoStr(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			eventName: "no kvs",
			kvs:       EventMetadata{},
			expected:  `{"console_type":"DEVLOOP","client_install_id":"00000000-0000-0000-0000-000000000000","event_name":"no kvs","event_metadata":[]}`,
			wantErr:   false,
		},
		{
			name:      "with kvs",
			...
			expected: `{"console_type":"DEVLOOP","client_install_id":"00000000-0000-0000-0000-000000000000","event_name":"with kvs","event_metadata":[{"key":"key1","value":"value1"},{"key":"key2","value":"value2"}]}`,
			wantErr:  false,
		},
		{
