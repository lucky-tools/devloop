...
import (
	...
	"github.com/lucky-tools/devloop/pkg/devloop/kubernetes/debugging/adapter"
...
func TestJdwpTransformerApply(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			debugConfig: types.ContainerDebugConfiguration{Runtime: "jvm", Ports: map[string]uint32{"jdwp": 8000}},
		},
		{
