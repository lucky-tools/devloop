  ...
  - image: gcr.io/k8s-devloop/example:latest
    name: example`,
			platforms: map[string][]spec.Platform{
				"gcr.io/k8s-devloop/example:latest": {{Architecture: "amd64", OS: "linux"}, {Architecture: "arm64", OS: "linux"}},
			},
...
spec:
  containers:
  - image: gcr.io/k8s-devloop/example1:latest
    name: example1
  - image: gcr.io/k8s-devloop/example2:latest
    name: example2`,
			platforms: map[string][]spec.Platform{
				"gcr.io/k8s-devloop/example1:latest": {{Architecture: "amd64", OS: "linux"}, {Architecture: "arm64", OS: "linux"}},
				"gcr.io/k8s-devloop/example2:latest": {{Architecture: "arm64", OS: "linux"}, {Architecture: "arm", OS: "freebsd"}},
			},
			expected: map[string][]spec.Platform{
...
spec:
  ...
  - image: gcr.io/k8s-devloop/example2:latest
    name: example2`,
			platforms: map[string][]spec.Platform{
				"gcr.io/k8s-devloop/example1:latest": {{Architecture: "amd64", OS: "linux"}, {Architecture: "arm64", OS: "linux"}},
				"gcr.io/k8s-devloop/example2:latest": {{Architecture: "arm", OS: "freebsd"}},
			},
			expected: map[string][]spec.Platform{
				".spec": nil,
			},
