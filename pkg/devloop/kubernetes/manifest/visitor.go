...
// TransformAllowlist is the default allowlist of kinds that can be transformed by Devloop.
...
// TransformDenylist is the default denylist on the set of kinds that can be transformed by Devloop.
