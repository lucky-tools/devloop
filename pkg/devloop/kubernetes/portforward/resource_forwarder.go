...
// Start gets a list of services deployed by devloop as []latest.PortForwardResource and
// forwards them.
...
func (p *ResourceForwarder) getCurrentEntry(resource latest.PortForwardResource) *portForwardEntry {
	...
	// https://github.com/lucky-tools/devloop/pull/5554#issuecomment-803270340
