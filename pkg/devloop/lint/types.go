...
// Options holds flag values for the various `devloop lint` commands
type Options struct {
...
const (
	...
	DevloopYamlAPIVersionOutOfDate
	DevloopYamlUseStaticPort
	DevloopYamlSyncPython
...
type InputParams struct {
	...
	DevloopConfig            *parser.DevloopConfigEntry
