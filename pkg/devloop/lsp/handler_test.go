...
func run(ctx context.Context, nc io.ReadWriteCloser) jsonrpc2.Conn {
	...
	conn.Go(ctx, GetHandler(conn, nil, config.DevloopOptions{}, func(ctx context.Context, out io.Writer, opts config.DevloopOptions) (runner.Runner, []util.VersionedConfig, *runcontext.RunContext, error) {
