...
// DefaultLogLevel for the global Devloop logger
...
// logger is the global logrus.Logger for Devloop
...
// SetupLogs sets up logrus logger for devloop command line
...
// AddHook adds a hook to the global Devloop logger.
func AddHook(hook logrus.Hook) {
	logger.AddHook(hook)
}

// SetLevel sets the global Devloop logger level.
func SetLevel(level Level) {
	logger.SetLevel(logrus.AllLevels[level])
}

// GetLevel returns the global Devloop logger level.
func GetLevel() Level {
...
//
// The mapping is:
// - ggcr Warn -> Devloop Error
// - ggcr Progress -> Devloop Info
// - ggcr Debug -> Devloop Trace
//
