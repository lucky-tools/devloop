...
func (r *DevloopRunner) DeployAndLog(ctx context.Context, out io.Writer, artifacts []graph.Artifact, list manifest.ManifestListByConfig) error {
...
func (r *DevloopRunner) Deploy(ctx context.Context, out io.Writer, artifacts []graph.Artifact, list manifest.ManifestListByConfig) error {
...
See https://devloop.dev/docs/pipeline-stages/taggers/#how-tagging-works`)
	}
...
func (r *DevloopRunner) wasBuilt(tag string) bool {
