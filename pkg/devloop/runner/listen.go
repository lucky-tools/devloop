...
func NewDevloopListener(monitor filemon.Monitor, trigger trigger.Trigger, cache graph.SourceDependenciesCache,
	intentChan <-chan bool,
) *DevloopListener {
	return &DevloopListener{
		Monitor:                 monitor,
		Trigger:                 trigger,
...
func (l *DevloopListener) LogWatchToUser(out io.Writer) {
...
func (l *DevloopListener) WatchForChanges(ctx context.Context, out io.Writer, devLoop func() error) error {
...
func (l *DevloopListener) do(devLoop func() error) error {
