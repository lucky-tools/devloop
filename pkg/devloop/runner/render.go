...
import (
	...
	"github.com/lucky-tools/devloop/pkg/devloop/render/util"
)

func (r *DevloopRunner) Render(ctx context.Context, out io.Writer, builds []graph.Artifact, offline bool) (manifest.ManifestListByConfig, error) {
