...
// ErrorConfigurationChanged is a special error that's returned when the devloop configuration was changed.
var ErrorConfigurationChanged = errors.New("configuration changed")

// Runner is responsible for running the devloop build, test and deploy config.
...
// DevloopRunner is responsible for running the devloop build, test and deploy config.
type DevloopRunner struct {
	Builder
	Pruner
	tester test.Tester
...
func (r *DevloopRunner) DeployManifests() manifest.ManifestListByConfig {
