...
import (
	...
	kRenderer "github.com/lucky-tools/devloop/pkg/devloop/render/renderer/kubectl"
...
func (r *DevloopRunner) WithMonitor(m filemon.Monitor) *DevloopRunner {
	r.monitor = m
	return r
}
...
func createRunner(t *testutil.T, testBench *TestBench, monitor filemon.Monitor, artifacts []*latest.Artifact, autoTriggers *triggerState) *DevloopRunner {
	tmpDir := t.NewTempDir()
	tmpDir.Chdir()
	if autoTriggers == nil {
