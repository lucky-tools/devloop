...
func (r *DevloopRunner) VerifyAndLog(ctx context.Context, out io.Writer, artifacts []graph.Artifact) error {
...
func (r *DevloopRunner) Verify(ctx context.Context, out io.Writer, artifacts []graph.Artifact) error {
