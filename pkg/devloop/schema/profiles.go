...
import (
	...
	skutil "github.com/lucky-tools/devloop/pkg/devloop/util"
...
// ApplyProfiles modifies the input devloop configuration by the application
// of a list of profiles, and returns the list of applied profiles.
func ApplyProfiles(c *latest.DevloopConfig, fieldsOverrodeByProfile map[string]configlocations.YAMLOverrideInfo, opts cfg.DevloopOptions, namedProfiles []string) ([]string, map[string]configlocations.YAMLOverrideInfo, error) {
...
func activatedProfiles(profiles []latest.Profile, opts cfg.DevloopOptions, namedProfiles []string) ([]string, []string, error) {
...
func isProfileActivated(profile latest.Profile, opts cfg.DevloopOptions) (bool, bool, error) {
...
func isAnyActivationTriggered(profile latest.Profile, opts cfg.DevloopOptions) (bool, bool, error) {
...
// When the profile is activated, the second returned value indicates whether the profile is context-specific.
func isAllActivationsTriggered(profile latest.Profile, opts cfg.DevloopOptions) (bool, bool, error) {
...
func isActivationTriggered(cond latest.Activation, opts cfg.DevloopOptions) (bool, error) {
...
func isCommand(command string, opts cfg.DevloopOptions) bool {
	if command == "" {
		return true
	}
...
func isKubeContext(kubeContext string, opts cfg.DevloopOptions) (bool, error) {
	if kubeContext == "" {
		return true, nil
	}
...
func applyProfile(config *latest.DevloopConfig, fieldsOverrodeByProfile map[string]configlocations.YAMLOverrideInfo, profile latest.Profile) error {
