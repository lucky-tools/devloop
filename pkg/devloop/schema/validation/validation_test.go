...
var cfgWithErrors = &latest.DevloopConfig{
...
func TestValidateSchema(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			err := Process(parser.DevloopConfigSet{&parser.DevloopConfigEntry{DevloopConfig: test.cfg, YAMLInfos: configlocations.NewYAMLInfos()}},
...
func TestVisitStructs(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			actual := visitStructs(&parser.DevloopConfigEntry{YAMLInfos: configlocations.NewYAMLInfos()}, reflect.ValueOf(test.input), alwaysErr)
...
func TestValidateNetworkMode(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			err := Process(parser.DevloopConfigSet{&parser.DevloopConfigEntry{
				YAMLInfos: configlocations.NewYAMLInfos(),
...
func TestValidateCustomDependencies(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			errs := validateCustomDependencies(&parser.DevloopConfigEntry{
				YAMLInfos: configlocations.NewYAMLInfos(),
				DevloopConfig: &latest.DevloopConfig{
					Pipeline: latest.Pipeline{
						Build: latest.BuildConfig{
...
func TestValidatePortForwardResources(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.resourceType, func(t *testutil.T) {
			...
			errs := validatePortForwardResources(&parser.DevloopConfigEntry{YAMLInfos: configlocations.NewYAMLInfos()}, pfrs)
			var err error
			if len(errs) > 0 {
				err = errs[0].Error
			}
...
func TestValidateImageNames(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			err := Process(
				parser.DevloopConfigSet{
					&parser.DevloopConfigEntry{
						YAMLInfos: configlocations.NewYAMLInfos(),
						DevloopConfig: &latest.DevloopConfig{
							Pipeline: latest.Pipeline{
								Build: latest.BuildConfig{
...
func TestValidateKoSync(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			err := Process(parser.DevloopConfigSet{cfg}, Options{CheckDeploySource: false})
...
func TestValidateAcyclicDependencies(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			errs := validateAcyclicDependencies(&parser.DevloopConfigSet{
				&parser.DevloopConfigEntry{
					YAMLInfos: configlocations.NewYAMLInfos(),
				},
			}, artifacts)
...
func TestValidateTaggingPolicy(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			err := Process(parser.DevloopConfigSet{
				&parser.DevloopConfigEntry{
					YAMLInfos: configlocations.NewYAMLInfos(),
					DevloopConfig: &latest.DevloopConfig{
						Pipeline: latest.Pipeline{
...
func TestValidateCustomTest(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			errs := validateCustomTest(&parser.DevloopConfigEntry{
				YAMLInfos: configlocations.NewYAMLInfos(),
				DevloopConfig: &latest.DevloopConfig{
					Pipeline: latest.Pipeline{
...
func TestValidateKubectlManifests(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			set := parser.DevloopConfigSet{}
			for _, c := range test.configs {
				set = append(set, &parser.DevloopConfigEntry{DevloopConfig: c, YAMLInfos: configlocations.NewYAMLInfos()})
			}
