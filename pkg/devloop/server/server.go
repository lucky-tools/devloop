...
import (
	...
	v2 "github.com/lucky-tools/devloop/pkg/devloop/server/v2"
	"github.com/lucky-tools/devloop/pkg/devloop/util"
	protoV1 "github.com/lucky-tools/devloop/proto/v1"
...
func Initialize(opts config.DevloopOptions) (func() error, error) {
	emptyCallback := func() error { return nil }
	if opts.RPCPort.Value() == nil && opts.RPCHTTPPort.Value() == nil {
		log.Entry(context.TODO()).Debug("devloop API not starting as it's not requested")
...
func newGRPCServer(preferredPort int) (func() error, int, error) {
	...
	protoV1.RegisterDevloopServiceServer(s, srv)
	protoV2.RegisterDevloopV2ServiceServer(s, v2.Srv)
...
func newHTTPServer(preferredPort, proxyPort int) (func() error, error) {
	...
	err := protoV1.RegisterDevloopServiceHandlerFromEndpoint(context.Background(), mux, net.JoinHostPort(util.Loopback, strconv.Itoa(proxyPort)), opts)
	if err != nil {
		return func() error { return nil }, err
	}
	err = protoV2.RegisterDevloopV2ServiceHandlerFromEndpoint(context.Background(), mux, net.JoinHostPort(util.Loopback, strconv.Itoa(proxyPort)), opts)
	if err != nil {
		return func() error { return nil }, err
	}
