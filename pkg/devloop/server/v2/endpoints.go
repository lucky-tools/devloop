...
func (s *Server) Events(_ *empty.Empty, stream proto.DevloopV2Service_EventsServer) error {
	return event.ForEachEvent(stream.Send)
}

func (s *Server) ApplicationLogs(_ *empty.Empty, stream proto.DevloopV2Service_ApplicationLogsServer) error {
