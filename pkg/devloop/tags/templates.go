...
//   - map[string]*string
//
// The function uses the "devloop" struct tag to identify fields that should be
// treated as templates. A field is considered a template if its "devloop" tag
