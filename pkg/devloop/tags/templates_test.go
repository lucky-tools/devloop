...
func TestApplyTemplates(t *testing.T) {
	type Inner struct {
		Name string `devloop:"template"`
	}
	type testStruct struct {
		SimpleString  string             `devloop:"template"`
		PtrString     *string            `devloop:"template"`
		PtrPtrString  **string           `devloop:"template"`
		SliceString   []string           `devloop:"template"`
		ArrayString   [2]string          `devloop:"template"`
		MapString     map[string]string  `devloop:"template"`
		MapPtrString  map[string]*string `devloop:"template"`
...
func TestContainTemplateTag(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			sf: reflect.StructField{
				Tag: reflect.StructTag(`devloop:"template"`),
			},
			want: true,
		},
		{
			...
			sf: reflect.StructField{
				Tag: reflect.StructTag(`devloop:"template,option1,option2"`),
			},
			want: true,
		},
		{
			...
			sf: reflect.StructField{
				Tag: reflect.StructTag(`devloop:"option1,option2"`),
			},
			want: false,
		},
		{
