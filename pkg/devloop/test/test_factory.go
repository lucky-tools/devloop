...
import (
	...
	"github.com/lucky-tools/devloop/pkg/devloop/logfile"
	"github.com/lucky-tools/devloop/pkg/devloop/output"
	"github.com/lucky-tools/devloop/pkg/devloop/schema/latest"
	"github.com/lucky-tools/devloop/pkg/devloop/test/custom"
	"github.com/lucky-tools/devloop/pkg/devloop/test/structure"
)
...
// NewTester parses the provided test cases from the Devloop config,
...
func getImageTesters(ctx context.Context, cfg docker.Config, imagesAreLocal func(imageName string) (bool, error), tcs []*latest.TestCase) (ImageTesters, error) {
