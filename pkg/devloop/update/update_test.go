...
func TestCheckVersions(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected: []string{
				"There is a new version (1.1.0) of Devloop available. Download it from:\n  https://github.com/lucky-tools/devloop/releases/tag/v1.1.0\n",
				"Your Devloop version might be too old. Download the latest version (1.1.0) from:\n  https://github.com/lucky-tools/devloop/releases/tag/v1.1.0\n",
			},
		},
		{
...
func latestGreaterThanCurrent() (semver.Version, semver.Version, error) {
	return semver.Version{Major: 1, Minor: 1, Patch: 0}, semver.Version{Major: 1, Minor: 0, Patch: 0}, nil
}

func currentEqualsLatest() (semver.Version, semver.Version, error) {
	return semver.Version{Major: 1, Minor: 0, Patch: 0}, semver.Version{Major: 1, Minor: 0, Patch: 0}, nil
}
